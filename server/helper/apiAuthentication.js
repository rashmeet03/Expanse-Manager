...
// Update this function in your existing apiAuthentication.js
exports.generateAccessToken = (emailId, expiresIn = '24h') => {
    return jwt.sign({ emailId }, process.env.ACCESS_TOKEN_SECRET, { expiresIn });
}
